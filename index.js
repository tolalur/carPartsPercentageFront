    ...
    <div class="hero-body">
      <div class="level has-text-centered">
        <div class="container">
          ...
          <h2 class="subtitle">Тест, описание текст.</h2>
        </div>
      </div>
    </div>
  </section>
...
const view = (state, actions) => (
  <div class="container">
    ...
    <div class="tile is-ancestor">
      {((state.targetSearch.autodoc && state.targetSearch.autodoc.length > 0) ||
      ...
      {((state.targetSearch.exist && state.targetSearch.exist.length > 0) ||
